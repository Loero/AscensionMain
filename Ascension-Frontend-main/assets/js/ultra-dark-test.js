...
function initUltraDarkInteractions() {
    ...
    const buttons = document.querySelectorAll('.btn-calculate, .btn-save-workout, .btn-back-home');
    ...
    const sections = document.querySelectorAll('.data-input-section, .result-section, .training-section, .tracker-section');
    sections.forEach(section => {
        section.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 8px 32px rgba(0, 0, 0, 0.9), 0 0 20px rgba(183, 28, 28, 0.2)';
        });
...
function initCrimsonGlow() {
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            this.style.boxShadow = 'inset 0 1px 3px rgba(0, 0, 0, 0.5), 0 0 25px rgba(183, 28, 28, 0.3)';
        });
    ...
    requiredInputs.forEach(input => {
        input.addEventListener('blur', function() {
            if (!this.value) {
                ...
                this.style.boxShadow = 'inset 0 1px 3px rgba(0, 0, 0, 0.5), 0 0 15px rgba(183, 28, 28, 0.3)';
            } else {
...
// Enhanced calculateAndGenerate function
...
// Generate training plan with ultra-dark styling
function generateTrainingPlan(experience, goal) {
    ...
    planCards.forEach(card => {
        ...
        card.style.boxShadow = 'inset 0 1px 3px rgba(0, 0, 0, 0.5), 0 0 15px rgba(183, 28, 28, 0.2)';
    });
}
